...
Purpose: This program calculates water_coloumn_height, pressure_gain_from_water_height, pressure_lost_from_pipe.
Extra Credit: Made global variables available to all functions, created function to convert kpa to psi and test function.
"""
...
def pressure_loss_from_fittings(fluid_velocity, quantity_fittings):
    fittings_lost_pressure = -0.04 * WATER_DENSITY * fluid_velocity ** 2 * quantity_fittings / 2000
    return fittings_lost_pressure
